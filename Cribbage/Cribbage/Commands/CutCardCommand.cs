...
namespace Games.Domain.MainModule.Entities.CardGames.Cribbage.Commands
{
    public class CutCardCommand : CribbageCommandBase, ICommand
    {
        ...
        public void Execute()
        {
            ...
            {
                _args.GameState.OpeningRoundState.PlayersCutCard.Add(new SerializableKeyValuePair<int, SerializableCard> { Key = _args.PlayerID, Value = new SerializableCard(_args.CutCard) });
            }
