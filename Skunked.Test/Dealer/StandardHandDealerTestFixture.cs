...
namespace Skunked.Test.Dealer
{
    ...
    public class StandardHandDealerTestFixture
    {
        ...
        public void Test_Deal_StartingWithPlayer3()
        {
            ...
            var hands = handFactory.CreatePlayerHands(deck.Object, players, player3, handSize);
            ...
            var player3Actual = hands[player3].ToList();
            ...
            var player4Actual = hands[player4].ToList();
